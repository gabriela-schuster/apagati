defmodule ApagatiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ApagatiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ApagatiWeb.Gettext, "errors", msg, opts)
    end
  end
